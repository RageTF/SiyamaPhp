...
$.extend($.ui, { datetimepicker: { version: "1.8.2" } });
...
$.extend(datetimepicker.prototype, {
 ...
 var s = $(id).text(); if (s==59){ s=-1; } s++; if (s<10){ sss='0'+s; }else{sss=s;}  $(id).text(sss);   	        this._selectDate(this.seldateid, this.seldatestr);
	},
	_selectH:function(id){

 var s = $(id).text(); if (s==23){ s=-1; } s++; if (s<10){ sss='0'+s; }else{sss=s;}  $(id).text(sss);   		this._selectDate(this.seldateid, this.seldatestr);
	},
